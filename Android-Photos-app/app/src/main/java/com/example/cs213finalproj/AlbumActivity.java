            ...
            if(data.getClipData() != null) {
                ...
                for (int i = 0; i < x; i++) {
                    if (!uri.contains((data.getClipData()).getItemAt(i).getUri())) {
                        ...
                        //selectAlbum.addPhoto(new Photo("", data.getClipData().getItemAt(i).getUri().toString()));
...
//        adapter.notifyDataSetChanged();
        ...
        // break;
      //  Log.d("Here 22",selectAlbum.getPhoto().get(position).getFilePath());
      //  Log.d("check655", photos.get(position).getFilePath());
       ...
       display.setImageURI(null);
        ...
        //   for(Photo t: photos){
        //     Log.d("Hello8888", selectAlbum.getPhoto().get(position).getFilePath());
        //  }
...
//    }
    ...
    public void MovePhoto(View view) {
        ...
        for(Album album: albums){
            ...
            if(album.getAlbum().equals(m)){
                ...
                //album.getPhoto().set(selected_idx,currentPhoto);
                //selectAlbum.getPhoto().remove(shownPhoto);
                if(photos.get(position).getFilePath().equals(shownPhoto.getFilePath())){
                    photos.remove(shownPhoto);
    ...
    public void OpenPhoto(View view) {
        ...
        startActivity(myIntent);
//        Toast.makeText(AlbumActivity.this, "photo name" + shownPhoto.getFilePath(),)

    }


//    public void OpenPhoto(View view) {
////        shownPhoto = getDisplayedPhoto();
////        saveData();
